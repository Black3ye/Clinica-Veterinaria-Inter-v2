<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportType.aspx.vb" Inherits="Clinica_Veterinaria_Inter_v2.ReportType" %>
...
<head runat="server">
    <title>Reportes de Tipo de Producto</title>
    <style type="text/css">
        .auto-style1 {
            margin-left: 300px;
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="782px" Font-Names="Verdana" ToolbaritemborderWidth ="1px" ToolbaritemPressedBorderstyle="Solid" 
                        ...
                        <LocalReport ReportPath="Reportes\rptType.rdlc">
                            <DataSources>
