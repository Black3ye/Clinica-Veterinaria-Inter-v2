<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportC.aspx.vb" Inherits="Clinica_Veterinaria_Inter_v2.ReportC" %>
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1094px" Font-Names="Verdana" ToolbaritemborderWidth ="1px" ToolbaritemPressedBorderstyle="Solid" 
                        ...
                        <LocalReport ReportPath="Reportes\rptPurchase.rdlc">
                            <DataSources>
