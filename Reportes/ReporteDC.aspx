<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReporteDC.aspx.vb" Inherits="Clinica_Veterinaria_Inter_v2.ReporteDC" %>
...
<head runat="server">
    <title>Reporte de Detalle de Compra</title>
    <style type="text/css">
        .auto-style1 {
            margin-left: 100px;
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1094px" Font-Names="Verdana" ToolbaritemborderWidth ="1px" ToolbaritemPressedBorderstyle="Solid" 
                        ...
                        <LocalReport ReportPath="Reportes\rptDPurchase.rdlc">
                            <DataSources>
