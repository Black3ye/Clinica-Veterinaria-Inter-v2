<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportInvoice.aspx.vb" Inherits="Clinica_Veterinaria_Inter_v2.ReportInvoice" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1100px" Font-Names="Verdana" ToolbaritemborderWidth ="1px" ToolbaritemPressedBorderstyle="Solid" 
                        ...
                        <LocalReport ReportPath="Reportes\rptInvoice.rdlc">
                            <DataSources>
