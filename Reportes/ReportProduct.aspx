<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportProduct.aspx.vb" Inherits="Clinica_Veterinaria_Inter_v2.ReportProduct" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1300px" Font-Names="Verdana" ToolbaritemborderWidth ="1px" ToolbaritemPressedBorderstyle="Solid" 
                        ...
                        <LocalReport ReportPath="Reportes\rptProduct.rdlc">
                            <DataSources>
