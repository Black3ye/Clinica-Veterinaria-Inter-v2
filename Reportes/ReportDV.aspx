<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportDV.aspx.vb" Inherits="Clinica_Veterinaria_Inter_v2.ReportDV" %>
...
<head runat="server">
    <title>Reporte de Detalle de Venta</title>
    <style type="text/css">
        .auto-style1 {
            margin-left: 100px;
        }
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="1094px" Font-Names="Verdana" ToolbaritemborderWidth ="1px" ToolbaritemPressedBorderstyle="Solid" 
                        ...
                        <LocalReport ReportPath="Reportes\rptDInvoice.rdlc">
                            <DataSources>
